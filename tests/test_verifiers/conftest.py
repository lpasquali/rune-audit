...
def passing_bundle() -> AttestationBundle:
    return AttestationBundle(repo="rune", tag="v0.0.0a2", found=True, payload={"predicate": {
...
def slsa_v1_bundle() -> AttestationBundle:
    return AttestationBundle(repo="rune-operator", tag="v0.0.0a2", found=True, payload={"predicate": {
...
def gh_verify_bundle() -> AttestationBundle:
    return AttestationBundle(repo="rune-ui", tag="v0.0.0a2", found=True, payload=[
